...
void start() async {
  ...
  final db = await Db.create(
      'mongodb+srv://admin:se1235@cluster0.inezx.mongodb.net/TravelDGwa?retryWrites=true&w=majority');
  await db.open();
  final coll = db.collection('hotel');
  ...
  serv.get('/', [
    ...
    (ServRequest req, ServResponse res) async {
      final hotel = await coll.find().toList();
